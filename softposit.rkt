...
(define (create-quire8) (make-quire8 0))
(define (create-quire16) (make-quire16 (list->cblock '(0 0) _uint64)))
(define (create-quire32) (make-quire32 (list->cblock '(0 0 0 0 0 0 0 0) _uint64)))
