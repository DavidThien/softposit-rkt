...
(define (create-quire8 [v null])
  (if eq? v null
    (make-quire8 0)
    (quire8-fdp-add (create-quire8) v (double->softposit8 1.0))))
(define (create-quire16 [v null])
  (if eq? v null
    (make-quire16 (list->cblock '(0 0) _uint64))
    (quire16-fdp-add (create-quire8) v (double->softposit8 1.0))))
(define (create-quire32 [v null])
  (if eq? v null
    (make-quire32 (list->cblock '(0 0 0 0 0 0 0 0) _uint64))
    (quire32-fdp-add (create-quire32) v (double->softposit32 1.0))))
